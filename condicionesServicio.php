...
<main>
    <div class="container">
        ...
        <h1><strong>Terminos y Condiciones de uso</strong></h1>
        <p>
            ...
            Notas Personales (https://notas-personales.herokuapp.com/) a través de su sitio web concede una licencia para que los usuarios utilicen  los productos que son vendidos en este sitio web de acuerdo a los Términos y Condiciones que se describen en este documento.
            ...
            Este sitio web Notas Personales (https://notas-personales.herokuapp.com/) garantiza que la información personal que usted envía cuenta con la seguridad necesaria. Los datos ingresados por usuario o en el caso de requerir una validación de los pedidos no serán entregados a terceros, salvo que deba ser revelada en cumplimiento a una orden judicial o requerimientos legales.

            La suscripción a boletines de correos electrónicos publicitarios es voluntaria y podría ser seleccionada al momento de crear su cuenta.

            Notas Personales (https://notas-personales.herokuapp.com/) reserva los derechos de cambiar o de modificar estos términos sin previo aviso.
        </p>
